...
{
    [BurstCompile]
    public struct NetCubeRotationPrecisionVariantGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                ...
                {
                    GhostFieldsHash = 11323648901984779963,
                    ...
                    VariantHash = 1099291954416493788,
                    CopyToSnapshot =
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                snapshot.ValueX = (int)math.round(component.Value.value.x * 100000);
                snapshot.ValueY = (int)math.round(component.Value.value.y * 100000);
                snapshot.ValueZ = (int)math.round(component.Value.value.z * 100000);
                snapshot.ValueW = (int)math.round(component.Value.value.w * 100000);
            }
        }
        [BurstCompile]
        [MonoPInvokeCallback(typeof(GhostComponentSerializer.CopyToFromSnapshotDelegate))]
        private static void CopyFromSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                var Value_Before = math.normalize(new quaternion(snapshotBefore.ValueX * 1E-05f, snapshotBefore.ValueY * 1E-05f, snapshotBefore.ValueZ * 1E-05f, snapshotBefore.ValueW * 1E-05f));
                var Value_After = math.normalize(new quaternion(snapshotAfter.ValueX * 1E-05f, snapshotAfter.ValueY * 1E-05f, snapshotAfter.ValueZ * 1E-05f, snapshotAfter.ValueW * 1E-05f));
